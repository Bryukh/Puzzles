...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsMain = __webpack_require__(207);

	var _componentsMain2 = _interopRequireDefault(_componentsMain);

	var _componentsPuzzlePagePuzzlePage = __webpack_require__(215);

	var _componentsPuzzlePagePuzzlePage2 = _interopRequireDefault(_componentsPuzzlePagePuzzlePage);

	(0, _reactDom.render)(_react2['default'].createElement(
	    _reactRouter.Router,
	    null,
	    _react2['default'].createElement(_reactRouter.Route, { path: '/', component: _componentsMain2['default'] }),
	    _react2['default'].createElement(_reactRouter.Route, { path: 'puzzle/:title', component: _componentsPuzzlePagePuzzlePage2['default'] })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsonPuzzleInfoJson = __webpack_require__(210);

	var _jsonPuzzleInfoJson2 = _interopRequireDefault(_jsonPuzzleInfoJson);
	...
	var Main = _react2['default'].createClass({
	    ...
	    render: function render() {
	        var blocks = _jsonPuzzleInfoJson2['default'].map(function (info, index) {
	            var imageURL = info.imageURL && info.imageURL.length ? info.imageURL : "default.png";
	            return _react2['default'].createElement(
	                'a',
	                { href: '#/puzzle/' + info.slug, key: index },
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'col-xs-6 col-sm-4 col-md-3 text-center' },
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'image-description' },
	                        _react2['default'].createElement('img', { src: './images/' + imageURL, alt: info.title })
	                    ),
	                    _react2['default'].createElement(
	                        'h1',
	                        null,
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "http://bryukh.com" },
	                            "Valentin Bryukhanov aka Bryukh"
	                        ),
	                        ". All sources ",
	                        _react2["default"].createElement(
	                            "a",
	                            { href: "https://github.com/Bryukh/Puzzles" },
	                            " here "
	                        ),
	                        "."
	                    )
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "col-xs-12 col-xs-offset-1 col-md-10 col-md-offset-2" },
	                            _react2["default"].createElement(
	                                "h1",
	                                null,
	...
	module.exports = [
		{
			"slug": "15puzzle",
			"short": "SLIDING!",
			"imageURL": "15puzzle.png",
			"title": "15 Puzzle"
		},
		{
			"slug": "painter",
			"short": "PAINTER!",
			"imageURL": "painter.png",
			"title": "Painter"
		}
	];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PuzzleNav = __webpack_require__(216);

	var _PuzzleNav2 = _interopRequireDefault(_PuzzleNav);

	__webpack_require__(217);

	var PuzzlePage = (function (_React$Component) {
	    _inherits(PuzzlePage, _React$Component);

	    function PuzzlePage() {
	        _classCallCheck(this, PuzzlePage);

	        _get(Object.getPrototypeOf(PuzzlePage.prototype), 'constructor', this).call(this);
	        this.state = {
	            puzzleComponent: null
	        };
	    }

	    _createClass(PuzzlePage, [{
	        key: 'resetPuzzle',
	        ...
	        value: function componentWillMount() {
	            ...
	            var PuzzleLoad = __webpack_require__(219)("./" + this.props.params.title);
	            PuzzleLoad(function (module) {
	                _this.setState({ puzzleComponent: module });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var Puzzle = this.state.puzzleComponent;

	            return _react2['default'].createElement(
	                'div',
	                null,
	                _react2['default'].createElement(_PuzzleNav2['default'], { title: Puzzle ? Puzzle.title : "Loading...", onReset: this.resetPuzzle }),
	                Puzzle ? _react2['default'].createElement(Puzzle, { ref: 'puzzle' }) : ""
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PuzzleNav = (function (_React$Component) {
	    _inherits(PuzzleNav, _React$Component);

	    function PuzzleNav() {
	        _classCallCheck(this, PuzzleNav);

	        _get(Object.getPrototypeOf(PuzzleNav.prototype), "constructor", this).apply(this, arguments);
	    }

	    _createClass(PuzzleNav, [{
	        key: "handleReset",
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "ul",
	                        { className: "nav navbar-nav", style: { "float": "none", display: "inline-block" } },
	                        _react2["default"].createElement(
	                            "li",
	                            null,
	                            _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            ...
	                            _react2["default"].createElement(
	                                "a",
	                                { href: "#", onClick: this.handleReset.bind(this) },
	                                _react2["default"].createElement(
	                                    "span",
	                                    { className: "circle-fa" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./puzzle-page.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./puzzle-page.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
